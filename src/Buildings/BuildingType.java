...
public enum BuildingType {
    BARACKS(80,1, TechnologyType.BRONZEWORKING),
    ...
    COURTHHOUSE(200,5,TechnologyType.MATHEMATICS),
    ...
    PUBLICSCHOOL(350,3,TechnologyType.SCINTIFICTHEORY),
    SATRANSCOURT(220,0,TechnologyType.BANKING),
