...
public enum TerrainFeatureType {
    ...
    TerrainFeatureType(int food, int product, int gold, int combatModifier, int MP, ArrayList<TerrainFeature> possibleFeatures) {
        this.food = food;
    ...
    int MP;
    int combatModifier;
    ArrayList<TerrainFeature> possibleFeatures;
}
